...
func (c *submissionClientClient) GetMySubmissionStatus(ctx context.Context, in *GetMySubmissionStatusReq, opts ...grpc.CallOption) (*GetMySubmissionStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, SubmissionClient_GetMySubmissionStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *submissionClientClient) SetSubmission(ctx context.Context, in *SetSubmissionReq, opts ...grpc.CallOption) (*SetSubmissionResp, error) {
	...
	err := c.cc.Invoke(ctx, SubmissionClient_SetSubmission_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *submissionClientClient) GetSubmissionInfo(ctx context.Context, in *GetSubmissionInfoReq, opts ...grpc.CallOption) (*GetSubmissionInfoResp, error) {
	...
	err := c.cc.Invoke(ctx, SubmissionClient_GetSubmissionInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *submissionClientClient) GetAllSubmissionStatus(ctx context.Context, in *GetAllSubmissionStatusReq, opts ...grpc.CallOption) (*GetAllSubmissionStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, SubmissionClient_GetAllSubmissionStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSubmissionClientServer must be embedded to have
...
func (UnimplementedSubmissionClientServer) testEmbeddedByValue()                          {}
...
func RegisterSubmissionClientServer(s grpc.ServiceRegistrar, srv SubmissionClientServer) {
	// If the following call pancis, it indicates UnimplementedSubmissionClientServer was
